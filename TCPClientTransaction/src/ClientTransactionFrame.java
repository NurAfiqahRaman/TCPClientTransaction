 ...
 *
 */
public class ClientTransactionFrame extends JFrame {
	 ...
	 */
	public void updateServer (String orderID) {
		
		this.lblServerDate.setText(orderID);
